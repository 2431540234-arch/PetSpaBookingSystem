...
// Bat moi exception, tra ve JSON gon: {timestamp, status, message}
// thay vi de Spring tra trang loi HTML mac dinh, app Android se khong parse duoc
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleGeneric(Exception ex) {
        return buildResponse(HttpStatus.INTERNAL_SERVER_ERROR, "Da co loi xay ra: " + ex.getMessage());
    }
